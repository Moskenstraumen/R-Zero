...
run_generation_stage() {
  ...
  QUESTION_GEN_SAMPLES="${QUESTION_GEN_SAMPLES}" \
...
run_evaluation_stage() {
  ...
  QUESTION_EVAL_HOST="${QUESTION_EVAL_HOST}" \
  QUESTION_EVAL_PORT="${QUESTION_EVAL_PORT}" \
...
BASE_MODEL="${1:-/root/model/Qwen3-4B-Instruct-2507}"
MODEL_ABBR="${2:-qwen3-4b}"
...
echo "[main.sh] Eval params: num_samples=${QUESTION_EVAL_NUM_SAMPLES}, max_new_tokens=${QUESTION_EVAL_MAX_NEW_TOKENS}, timeout=${QUESTION_EVAL_REQUEST_TIMEOUT}s"
